...
$questions = [
    ...
    [
        'id' => '5-15',
        'question' => '財團法人台灣網路資訊中心（TWNIC）負責下列哪些辨識資訊的申請與核發？',
        'options' => [
            [
    ...
    [
        'id' => '5-16',
        'question' => '下列哪些類型的網域名稱屬於「泛用型」的網域名稱，依法登記的國內外公司、商號、法人或自然人均可申請？',
        'options' => [
            [
                'label' => '阿昌.tw',
                'value' => 'A'
    ...
    [
        'id' => '5-17',
        'question' => '在網際網路中常以 URL（Uniform Resource Locator）來表示網路資源的位址，URL 跟IP 位址的主要差異為下列哪一項？',
        'options' => [
            [
